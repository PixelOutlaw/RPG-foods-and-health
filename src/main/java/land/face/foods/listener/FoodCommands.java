    ...
    public boolean onCommand(CommandSender sender, Command command, String label, String[] args) {
        ...
        if (command.getLabel().equalsIgnoreCase("RPGFood") && sender.hasPermission("foods.command.stats") && sender instanceof Player) {
            ...
            if (args[0].equalsIgnoreCase("help") || args[0].equalsIgnoreCase("?") || args[0] == null) {
                ...
                player.sendMessage(ChatColor.WHITE + "/RPGFood SetNutrient <Player> <Nutrient> <Amount>" + ChatColor.GRAY + "- Sets target nutrient of a player");
                player.sendMessage(ChatColor.WHITE + "/RPGFood Reset <Player>" + ChatColor.GRAY + "- Resets targets nutritional stats");
                player.sendMessage(ChatColor.WHITE + "/RPGFood Reload" + ChatColor.GRAY + "- Reloads plugin");
